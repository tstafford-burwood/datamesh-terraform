...
variable "services" {
  ...
  type        = list(string)
  default     = ["dlp.googleapis.com", "accesscontextmanager.googleapis.com", "cloudbuild.googleapis.com", "iam.googleapis.com", "cloudbilling.googleapis.com", "cloudresourcemanager.googleapis.com"]
}
