...
locals {
  constants = {
    ...
    org_id                     = "575228741867" // CHANGE BEFORE FIRST DEPLOYMENT
    billing_account_id         = "01EF01-627C10-7CD2DF" // CHANGE BEFORE FIRST DEPLOYMENT
    srde_folder_id             = "823109093074" // CHANGE BEFORE FIRST DEPLOYMENT
    automation_project_id      = "automate-final-123" // CHANGE BEFORE FIRST DEPLOYMEN
    cloudbuild_service_account = "541640482517@cloudbuild.gserviceaccount.com" // CHANGE BEFORE FIRST DEPLOYMENT
