project_admins        = []
researchers           = ["group:groupA@example.com"]
data_stewards         = ["user:user1@exmaple.com"] # individual accounts only, no group, added to the access context to access the necessary foundation projects. Syntax is `user:foo@bar.com`
num_instances         = 0
