...
data_stewards         = ["user:datasteward@prorelativity.com"] # individual accounts only, no group, added to the access context to access the necessary foundation projects. Syntax is `user:foo@bar.com`
num_instances         = 0
