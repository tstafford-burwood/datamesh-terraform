...
variable "staging_project_regular_service_perimeter_description" {
  description = "Description of the regular perimeter"
  type        = string
  default     = ""
}

variable "staging_project_regular_service_perimeter_name" {
...
variable "staging_project_restricted_services" {
...
variable "staging_project_enable_restriction" {
...
variable "staging_project_allowed_services" {
