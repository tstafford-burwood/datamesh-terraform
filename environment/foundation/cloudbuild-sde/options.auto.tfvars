...
access_level_members_plan_trigger_tags     = []
access_level_members_plan_trigger_disabled = false

#-----------------------------------------------------------
# CLOUDBUILD TRIGGERS - SRDE ADMIN ACCESS LEVEL APPLY TFVARS
#-----------------------------------------------------------

access_level_members_apply_trigger_tags     = []
access_level_members_apply_trigger_disabled = false
