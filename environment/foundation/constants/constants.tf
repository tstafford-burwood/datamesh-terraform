...
locals {
  constants = {
    ...
    packer_base_image_id_bastion      = "custom-image-4f102f4"  // CHANGE AFTER NEW IMAGE IS CREATED
    packer_base_image_id_deeplearning = "deeplearning-image-fcb0466"  // CHANGE AFTER NEW IMAGE IS CREATED
