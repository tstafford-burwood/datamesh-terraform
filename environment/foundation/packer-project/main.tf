...
// PROVISION GCS BUCKET USED FOR CLOUDBUILD CONTAINER/ARTIFACT REGISTRY JOBS
...
module "packer_vpc" {
  ...
  routes                                 = var.routes
  depends_on                             = [google_project_service.enable_packer_project_apis]
}
...
module "packer_container_artifact_registry_repository" {
  ...
  #artifact_repository_location    = var.packer_container_artifact_repository_location
...
// PROVISION ARTIFACT REGISTRY REPOSITORY IN PACKER PROJECT FOR PATH ML CONTAINER IMAGE

#-----------------------------------------------
# PATH ML CONTAINER ARTIFACT REGISTRY REPOSITORY
#-----------------------------------------------
...
module "path_ml_container_artifact_registry_repository" {
  ...
  artifact_repository_format     = var.path_ml_container_artifact_repository_format
  #artifact_repository_location    = var.path_ml_container_artifact_repository_location
  artifact_repository_location    = local.packer_default_region
  artifact_repository_description = var.path_ml_container_artifact_repository_description
  artifact_repository_labels      = var.path_ml_container_artifact_repository_labels
}
...
module "terraform_validator_container_artifact_registry_repository" {
  ...
  #artifact_repository_location    = var.terraform_validator_container_artifact_repository_location
  artifact_repository_location    = local.packer_default_region
